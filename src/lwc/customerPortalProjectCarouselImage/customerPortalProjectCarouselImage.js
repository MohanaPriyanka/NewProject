/**
 * Created by rebeccanachison on 10/1/21.
 * Adapted from https://github.com/salesforce/base-components-recipes/blob/master/force-app/main/default/lwc/carouselImage/carouselImage.js
 */
...
export default class cCarouselImage extends LightningElement {
    ...
    //Updated by Rebecca Nachison 10/01/2021 - set image as background-image
    get backgroundImgStyle() {
        return `background-image: url(${this._src})`;
    }
    ...
    get href() {
        return `/s/shared-solar-system/${this.projectId}`;
    }
