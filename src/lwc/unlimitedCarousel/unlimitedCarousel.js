 ...
 * Modified from https://github.com/salesforce/base-components-recipes/blob/master/force-app/main/default/lwc/carousel/carousel.js
 */
...
// Updated by Rebecca Nachison 09/30/2021 -- add label values explicitly
...
// Updated by Rebecca Nachison 09/30/2021 -- add values from utilsPrivate explicitly
const keyCodes = {
    tab: 9,
    backspace: 8,
    enter: 13,
...
export default class cCarousel extends LightningElement {
    ...
    handlePrivateImageRegister(event) {
        ...
        //Updated by Rebecca Nachison 09/30/2021 - remove number of slides limitation
        // if (currentIndex > 5) {
        //     return;
        // }
