...
({
    renderPaymentFrame: function(component) {
        ...
        var prepopulatedFields = {
            creditCardHolderName: component.get('v.defaultName')?component.get('v.defaultName'):'',
            creditCardPostalCode: component.get('v.defaultZip')?component.get('v.defaultZip'):'',
            achBankAccountName: component.get('v.defaultName')?component.get('v.defaultName'):''
        };
