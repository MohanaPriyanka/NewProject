({  
    errorCheck : function(component, helper, newContact) {
        ...
        if (helper.invalidField(component, newContact.FirstName, null, true, false, true, "standard")) {
            errorMessage = errorMessage + "Please enter the Co-Signer's First Name without any special characters." + "\n" + "\n";
            helper.addErrorAnimation(component, "inputFirstName");
            
        } if (helper.invalidField(component, newContact.LastName, null, true, false, true, "standard")) {
            errorMessage = errorMessage + "Please enter the Co-Signer's Last Name without any special characters." + "\n" + "\n";
            helper.addErrorAnimation(component, "inputLastName");
            
        } if (helper.invalidField(component, newContact.Email, null, true, true, false, "email")) {
            errorMessage = errorMessage + "Please enter a valid email address." + "\n" + "\n";
            helper.addErrorAnimation(component, "inputEmail");
            
        } if (helper.invalidField(component, newContact.LASERCA__Home_Address__c, null, true, true, true, "standard")) {
            errorMessage = errorMessage + "Please enter the Co-Signer's correct home address." + "\n" + "\n";
            helper.addErrorAnimation(component, "inputStreet");
        
        } if (helper.invalidField(component, newContact.LASERCA__Home_City__c, null, true, true, true, "standard")) {
            errorMessage = errorMessage + "Please enter the Co-Signer's City" + "\n" + "\n";
            helper.addErrorAnimation(component, "inputCity");

        } if (newContact.LASERCA__Home_State__c == "Select") {
            errorMessage = errorMessage + "Please enter a valid State" + "\n" + "\n";
            helper.addErrorAnimation(component, "inputState");

        } if (helper.invalidField(component, newContact.LASERCA__Home_Zip__c, 5, false, false, false, "standard")) {
            errorMessage = errorMessage + "Please enter a valid 5 digit Zip Code"+ "\n" + "\n";
            helper.addErrorAnimation(component, "inputZip");
            
        } if (helper.invalidField(component, newContact.LASERCA__Co_Applicant_DOB__c, null, false, false, false, "date")) {
            errorMessage = errorMessage + "Please enter a Date of Birth in the format MM/DD/YYYY." + "\n" + "\n";
            helper.addErrorAnimation(component, "inputDOB");

        } if (helper.invalidField(component, newContact.LASERCA__Social_Security_Number__c, 9, false, false, false, "standard")) {
            errorMessage = errorMessage + "Please enter a valid 9 digit Social Security Number without any special characters/symbols." + "\n" + "\n";
            helper.addErrorAnimation(component, "inputSSN");
            
        } if (helper.invalidField(component, newContact.Income__c, null, false, false, false, "standard")) {
            errorMessage = errorMessage + "Please enter the Co-Signer's estimated annual income" + "\n" + "\n";
            helper.addErrorAnimation(component, "inputIncome");
        
        } if (newContact.Privacy_Policy_Acknowledged__c != true ) {
            errorMessage = errorMessage + "Please have the Co-Signer acknowledge BlueWave's Privacy Policy." + "\n" + "\n";
            helper.addErrorAnimation(component, "privacyPolicy");

        } if (newContact.Credit_Check_Acknowledged__c != true){    
            errorMessage = errorMessage + "Please have the Co-Signer give BlueWave and Avidia Bank permission to access their credit history." + "\n" + "\n";
