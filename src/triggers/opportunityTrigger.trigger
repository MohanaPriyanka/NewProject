trigger opportunityTrigger on opportunity (before insert, after insert, before update, after update) {
    createLoanHandler handler = new createLoanHandler(Trigger.isExecuting, Trigger.size);
    //mapSharedSolarSystemHandler handlerTwo = new mapSharedSolarSystemHandler(trigger.isExecuting, Trigger.size);
    /*
