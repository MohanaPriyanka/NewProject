...
If (trigger.isUpdate && opp.doer_solar_loann__c == TRUE && opp.Principall__c!= null && opp.DOER_Loan_Base_Rate__c != null && opp.BlueWave_Avidia_Rate__c != null) {    

decimal interestRate = opp.DOER_Loan_Base_Rate__c/100;
